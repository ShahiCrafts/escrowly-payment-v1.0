        ...
        <div className="max-w-5xl mx-auto space-y-8 pb-12">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-500 mt-1">Manage system alerts and administrative notifications</p>
                </div>
            ...
            <div className="space-y-4">
                {loading && notifications.length === 0 ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-slate-500 mt-2">No unread notifications to show.</p>
                    </div>
                ) : (
                    filteredNotifications.map((notification) => (
                        <Card
                            ...
                            className={cn(
                                "group transition-all duration-200 border border-slate-100 cursor-pointer hover:shadow-md",
                                !notification.read ? "bg-white ring-1 ring-blue-500/50" : "bg-white"
                            )}
